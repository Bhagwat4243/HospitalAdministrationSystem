...
namespace HospitalManagementSystem.Bl.PdfGeneratorFolder.Implementation
{
    public class PdfGenerate : IPdfGenerate
    {
                    ...
                    page.Content().PaddingVertical(20).Element(container =>
                    {
                        container.Column(col =>
                        {
                            ...
                            col.Item().PaddingTop(10).Table(table =>
                            {
                                ...
                                {
                                    table.Cell().Element(e => e.PaddingVertical(5)).Text(med.Medicine);
                                    table.Cell().Element(e => e.PaddingVertical(5)).Text(med.Dosage);
                                    table.Cell().Element(e => e.PaddingVertical(5)).Text(med.Frequancy);
